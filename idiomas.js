...
const EN = {
  ...
  'Este nodo no tiene pantalla: la de abajo es la del nodo Pantalla, solo de referencia.': 'This node has no screen: the one below belongs to the Display node, only for reference.',
  'Conectado': 'Connected',
